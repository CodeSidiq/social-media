...
const CommentSurfaceShell = ({
  ...
  const shouldShowCaptionToggle =
    (post.caption?.trim().length ?? 0) > COMMENT_MODAL_CAPTION_TOGGLE_THRESHOLD;
  ...
  return (
    <DialogContent
      ...
      className='h-[100dvh] max-w-none rounded-none border-none bg-transparent p-0 shadow-none md:h-auto md:w-[min(100vw-15rem,75rem)] md:max-w-none'
    >
      ...
      <div className='relative h-full min-h-0'>
        <div className='hidden md:block'>
          <div className='relative mx-auto mt-24 w-full max-w-[75rem] px-6 xl:px-0'>
            <DialogClose
              className='absolute -top-10 right-6 z-[90] inline-flex h-6 w-6 items-center justify-center text-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:right-0'
              aria-label='Close dialog'
            >
              <X className='h-6 w-6' />
            </DialogClose>

            <div className='grid h-[min(45rem,calc(100dvh-9rem))] w-full grid-cols-[minmax(0,1fr)_27.5rem] overflow-hidden border border-border bg-shell-background'>
