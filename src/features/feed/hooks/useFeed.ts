...
/**
 * Authenticated feed query hook.
 * Fetches timeline data and maps it into the shared UI-facing model.
 * Feed cache meaning must remain separate from explore data.
 */
